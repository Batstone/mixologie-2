          ...
          <ul className={styles["favorites__list"]}>
            {favorites.map((drink: any) => (
              <li key={drink.id}>
                ...
                <Button className={styles["favorites__button"]} title="Remove from favorites" onClick={() => removeFavorite(drink.id)}>
                  ...
                  <span className="sr-only">Remove drink from favorites</span>
                </Button>
              </li>
            ))}
          </ul>
